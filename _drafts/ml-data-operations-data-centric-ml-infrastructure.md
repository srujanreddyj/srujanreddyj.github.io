...
Related reference: [Batch, Streaming, and Merged Views in ML Data Operations]({% link references/batch-streaming-merged-views-ml-data-operations.md %}) explains how the batch lane, streaming lane, and merged serving/training view fit together. It is a direct-link reference page, not a homepage-listed post.
